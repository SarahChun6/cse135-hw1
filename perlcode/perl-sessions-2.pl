...
print "<br/><br/>";
print "<a href=\"/cgi-bin/perlcode/perl-sessions-1.pl\">Session Page 1</a><br/>";
print "<a href=\"/perl-cgiform.html\">Perl CGI Form</a><br />";
print "<form style=\"margin-top:30px\" action=\"/cgi-bin/perlcode/perl-destroy-session.pl\" method=\"get\">";
